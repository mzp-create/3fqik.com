...
export function MatchCard({
  ...
  return (
    <div className="mb-2 rounded-xl border border-border bg-surface p-4 shadow-sm">
      ...
      {/* Once the match has started, betting is closed — do not offer any
          tiles, only a notice. The eyebrow/LIVE badge/score above stay. */}
      {started ? (
        <p className="mt-2 rounded-lg bg-raised px-3 py-2 text-center text-sm font-semibold text-muted">
          ⏸ {t.matchStartedNote}
        </p>
      ) : (
        <>
