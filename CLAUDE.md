...
- Referrals: `players.referred_by` records the inviter; each player has a personal `invite_codes` row (`kind='personal'`); `settings.referral_bonus_mmk` reserved for future per-referral bonus.
